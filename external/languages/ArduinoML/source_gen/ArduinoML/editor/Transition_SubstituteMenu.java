...
public class Transition_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_ub2zs1_a(), CONCEPTS.Transition$x$));
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for Transition. Generated from implicit smart reference attribute.", new SNodePointer("r:0b8baeac-fdc0-4209-befa-dbc848c21b02(ArduinoML.structure)", "1094228618062899110")));
    try {
  ...
  public class SMP_ReferenceScope_ub2zs1_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_ub2zs1_a() {
      ...
      super((SAbstractConcept) CONCEPTS.Transition$x$, LINKS.next$BgsG);
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_ub2zs1_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.Transition$x$);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
