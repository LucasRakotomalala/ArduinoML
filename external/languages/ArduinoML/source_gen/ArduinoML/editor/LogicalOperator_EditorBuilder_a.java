...
/*package*/ class LogicalOperator_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftSingleRoleHandler_iyfdbj_b0(myNode, LINKS.left$xbxS, getEditorContext());
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightSingleRoleHandler_iyfdbj_d0(myNode, LINKS.right$xbZU, getEditorContext());
    return provider.createCell();
  }
